...
1. Selecciona "Gestión de Mascotas" en página inicial 
2. El sistema llama a la lista de mascotas del usuario y genera cards con la información de cada uno
3. Selecciona en el card de la mascota deseada una fecha en el calendario, una hora en form y da click en el boton de agendarse 
